...
import com.example.myapplication.Adapter.ClientListAdapater;
...
public class ClientsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.clientListClients);
        ...
        myAdapter = new ClientListAdapater(this, clientList);
        recyclerView.setAdapter(myAdapter);


        ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setTitle("Loading List of clients...");
        progressDialog.show();
